          ...
          {payload.map((item, index) => {
            ...
            return (
              <div
                key={item.dataKey}
                className={cn(
                  "flex w-full items-center gap-2 [&>svg]:h-2.5 [&>svg]:w-2.5 [&>svg]:text-foreground-muted",
                  ...
                  <>
                    ...
                    <div
                      className={cn(
                        ...
                        (payload?.length || 0) > 1 ? "items-stretch" : "items-center"
                      )}
                    >
                      <div className="grid gap-1.5">
