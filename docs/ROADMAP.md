...
| HP PDF storage | Upload historical tests to Convex | ✅ Done ([plan](plans/2026-01-25-convex-file-storage.md)) |
| HP PDF extraction | Parse questions/answers from PDFs | Planned |
