...
urls=(
  "https://www.studera.nu/hogskoleprov/fpn/normeringstabeller-hosten-20232/"
  "https://www.studera.nu/hogskoleprov/fpn/normeringstabeller-varen-2023/"
  "https://www.studera.nu/hogskoleprov/fpn/normeringstabeller-hosten-2022/"
  "https://www.studera.nu/hogskoleprov/fpn/normeringstabeller-varen-2022-7-maj/"
  "https://www.studera.nu/hogskoleprov/fpn/normeringstabeller-varen-2022-12-mars/"
  "https://www.studera.nu/hogskoleprov/fpn/normeringstabeller-hosten-2021/"
  "https://www.studera.nu/hogskoleprov/fpn/normeringstabeller-varen-2021-8-maj/"
  "https://www.studera.nu/hogskoleprov/fpn/normeringstabeller-varen-2021-13-mars/"
  "https://www.studera.nu/hogskoleprov/fpn/normeringstabeller-hosten-2020/"
)
for url in "${urls[@]}"; do
...
dirs=(hosten-2023 varen-2023 hosten-2022 varen-2022 varen-2022-mars hosten-2021 varen-2021 varen-2021-mars hosten-2020)
for dir in "${dirs[@]}"; do
...
# Count new PDF files (should be 27)
find apps/web/public/pdfs -name "norm*.pdf" -newer apps/web/public/pdfs/hosten-2025 2>/dev/null | wc -l
# Expected: 27 (or more if plan-01 also ran)
...
# Should show 39 (3 for hosten-2025 + 9 from plan-01 + 27 new)
  ...
  <done>
27 normering PDFs downloaded for 2020-2023 tests with verified file sizes (all >50KB). tests.ts updated with normering file entries for all 9 tests.
  </done>
</task>
...
# For each new JSON file, verify 5 data points match the source PDF
slugs=(hosten-2023 varen-2023 hosten-2022 varen-2022 varen-2022-mars hosten-2021 varen-2021 varen-2021-mars hosten-2020)
...
# RUNTIME VERIFICATION - Verify getNormeringData() can load new JSON files
cd apps/web && node -e "
  const fs = require('fs');
  const slugs = ['hosten-2023', 'varen-2023', 'hosten-2022', 'varen-2022', 'varen-2022-mars', 'hosten-2021', 'varen-2021', 'varen-2021-mars', 'hosten-2020'];
...
cd apps/web && bun run build 2>&1 | tail -5
  ...
  <done>
9 new JSON files created for 2020-2023 tests. All files validated for structure and data accuracy (mean, stdDev, participants, distribution rows verified against source PDFs). Runtime verification confirms getNormeringData() loads all data correctly. Build passes.
  </done>
</task>
...
<verification>
1. 27 normering PDFs downloaded to correct directories with verified sizes
...
5. Data accuracy verified against source PDFs (mean, stdDev, first/last rows)
6. Runtime verification: getNormeringData() loads all new data correctly
7. Build succeeds
8. Sample test pages display normering charts correctly
</verification>

<success_criteria>
- 27 normering PDFs downloaded and stored locally with verified sizes
...
- Runtime verification: getNormeringData() loads all data correctly
